 ...
 * Due: 9/13/23
 * Modify and add '^' and '%' to operations available for the evaluate expression method
 */
import java.util.*;
 
  public class EvaluateExpressionWill {
    public static void main(String[] args) {
      // Check number of arguments passed
    	Scanner input = new Scanner(System.in);
      	...
      	in=input.next();
      	System.out.print(in+"="+evaluateExpression(in)+"\n");
      if (args.length != 1) {         
